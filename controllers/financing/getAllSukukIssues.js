...
const getAllSukukIssues = async (req, res) => {
  try {
    ...
    return res.status(200).json({
      success: true,
      message: "Berhasil mendapatkan seluruh data sukuk",
      data,
    });
  } catch (error) {
    console.error("Error in getAllSukukIssues:", error);
...
export default getAllSukukIssues;
